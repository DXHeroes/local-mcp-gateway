...
## [0.1.4](https://github.com/DXHeroes/local-mcp-gateway/compare/ui-v0.1.3...ui-v0.1.4) (2026-01-13)


### Features

* enhance proxy handler to include server status tracking and update Profiles page to display server status. Introduce Badge component for visual representation of server status in the UI. ([4fb09a6](https://github.com/DXHeroes/local-mcp-gateway/commit/4fb09a6e8f2a10f0e9ce6f50150e3d3eac69fe29))
...
## [0.1.3](https://github.com/DXHeroes/local-mcp-gateway/compare/local-mcp-ui-v0.1.2...local-mcp-ui-v0.1.3) (2026-01-12)
