...
export const McpServerToolsCacheMinOrderByAggregateInputSchema: z.ZodType<Prisma.McpServerToolsCacheMinOrderByAggregateInput> = z.strictObject({
...
export default McpServerToolsCacheMinOrderByAggregateInputSchema;
