...
export const DebugLogMinOrderByAggregateInputSchema: z.ZodType<Prisma.DebugLogMinOrderByAggregateInput> = z.strictObject({
...
export default DebugLogMinOrderByAggregateInputSchema;
