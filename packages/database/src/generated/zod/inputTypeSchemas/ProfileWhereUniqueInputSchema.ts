...
import { z } from 'zod';
import { ProfileOrganizationIdNameCompoundUniqueInputSchema } from './ProfileOrganizationIdNameCompoundUniqueInputSchema';
...
export const ProfileWhereUniqueInputSchema: z.ZodType<Prisma.ProfileWhereUniqueInput> = z.union([
  z.object({
    id: z.uuid(),
    organizationId_name: z.lazy(() => ProfileOrganizationIdNameCompoundUniqueInputSchema),
  }),
  z.object({
    id: z.uuid(),
  }),
...
.and(z.strictObject({
  id: z.uuid().optional(),
  organizationId_name: z.lazy(() => ProfileOrganizationIdNameCompoundUniqueInputSchema).optional(),
