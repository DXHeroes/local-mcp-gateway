...
export const DebugLogUncheckedCreateNestedManyWithoutProfileInputSchema: z.ZodType<Prisma.DebugLogUncheckedCreateNestedManyWithoutProfileInput> = z.strictObject({
...
export default DebugLogUncheckedCreateNestedManyWithoutProfileInputSchema;
