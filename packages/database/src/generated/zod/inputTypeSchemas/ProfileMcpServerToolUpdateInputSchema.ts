...
import { ProfileMcpServerUpdateOneRequiredWithoutToolsNestedInputSchema } from './ProfileMcpServerUpdateOneRequiredWithoutToolsNestedInputSchema';

export const ProfileMcpServerToolUpdateInputSchema: z.ZodType<Prisma.ProfileMcpServerToolUpdateInput> = z.strictObject({
  ...
  profileMcpServer: z.lazy(() => ProfileMcpServerUpdateOneRequiredWithoutToolsNestedInputSchema).optional(),
});

export default ProfileMcpServerToolUpdateInputSchema;
