...
import { UserUpdateOneRequiredWithoutMcpServersNestedInputSchema } from './UserUpdateOneRequiredWithoutMcpServersNestedInputSchema';
...
export const McpServerUpdateWithoutOauthClientRegistrationsInputSchema: z.ZodType<Prisma.McpServerUpdateWithoutOauthClientRegistrationsInput> = z.strictObject({
  ...
  presetId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  user: z.lazy(() => UserUpdateOneRequiredWithoutMcpServersNestedInputSchema).optional(),
...
export default McpServerUpdateWithoutOauthClientRegistrationsInputSchema;
