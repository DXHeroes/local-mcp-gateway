...
export const ProfileMcpServerUpsertArgsSchema: z.ZodType<Prisma.ProfileMcpServerUpsertArgs> = z.object({
  ...
  create: z.union([ ProfileMcpServerCreateInputSchema, ProfileMcpServerUncheckedCreateInputSchema ]),
  update: z.union([ ProfileMcpServerUpdateInputSchema, ProfileMcpServerUncheckedUpdateInputSchema ]),
}).strict();

export default ProfileMcpServerUpsertArgsSchema;
