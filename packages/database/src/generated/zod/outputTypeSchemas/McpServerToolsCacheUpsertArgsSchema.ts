...
export const McpServerToolsCacheUpsertArgsSchema: z.ZodType<Prisma.McpServerToolsCacheUpsertArgs> = z.object({
  ...
  create: z.union([ McpServerToolsCacheCreateInputSchema, McpServerToolsCacheUncheckedCreateInputSchema ]),
  update: z.union([ McpServerToolsCacheUpdateInputSchema, McpServerToolsCacheUncheckedUpdateInputSchema ]),
}).strict();

export default McpServerToolsCacheUpsertArgsSchema;
