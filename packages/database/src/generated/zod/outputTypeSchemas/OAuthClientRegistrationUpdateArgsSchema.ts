...
export const OAuthClientRegistrationUpdateArgsSchema: z.ZodType<Prisma.OAuthClientRegistrationUpdateArgs> = z.object({
  select: OAuthClientRegistrationSelectSchema.optional(),
  include: z.lazy(() => OAuthClientRegistrationIncludeSchema).optional(),
  data: z.union([ OAuthClientRegistrationUpdateInputSchema, OAuthClientRegistrationUncheckedUpdateInputSchema ]),
  where: OAuthClientRegistrationWhereUniqueInputSchema, 
}).strict();

export default OAuthClientRegistrationUpdateArgsSchema;
