...
export const ProfileMcpServerToolUpdateManyArgsSchema: z.ZodType<Prisma.ProfileMcpServerToolUpdateManyArgs> = z.object({
...
export default ProfileMcpServerToolUpdateManyArgsSchema;
