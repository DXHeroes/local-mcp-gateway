...
export const OAuthClientRegistrationFindManyArgsSchema: z.ZodType<Prisma.OAuthClientRegistrationFindManyArgs> = z.object({
...
export default OAuthClientRegistrationFindManyArgsSchema;
