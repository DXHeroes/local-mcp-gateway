...
export const DebugLogFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.DebugLogFindUniqueOrThrowArgs> = z.object({
  select: DebugLogSelectSchema.optional(),
  include: z.lazy(() => DebugLogIncludeSchema).optional(),
  where: DebugLogWhereUniqueInputSchema, 
}).strict();

export default DebugLogFindUniqueOrThrowArgsSchema;
