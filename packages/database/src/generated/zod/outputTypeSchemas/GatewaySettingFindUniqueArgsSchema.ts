...
export const GatewaySettingFindUniqueArgsSchema: z.ZodType<Prisma.GatewaySettingFindUniqueArgs> = z.object({
  select: GatewaySettingSelectSchema.optional(),
  where: GatewaySettingWhereUniqueInputSchema, 
}).strict();

export default GatewaySettingFindUniqueArgsSchema;
