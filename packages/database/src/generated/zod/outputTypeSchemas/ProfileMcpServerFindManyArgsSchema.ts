...
export const ProfileMcpServerFindManyArgsSchema: z.ZodType<Prisma.ProfileMcpServerFindManyArgs> = z.object({
...
export default ProfileMcpServerFindManyArgsSchema;
