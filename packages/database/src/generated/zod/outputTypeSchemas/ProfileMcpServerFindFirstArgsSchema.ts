...
export const ProfileMcpServerFindFirstArgsSchema: z.ZodType<Prisma.ProfileMcpServerFindFirstArgs> = z.object({
...
export default ProfileMcpServerFindFirstArgsSchema;
