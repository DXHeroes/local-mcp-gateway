...
export const ProfileMcpServerToolUpsertArgsSchema: z.ZodType<Prisma.ProfileMcpServerToolUpsertArgs> = z.object({
  ...
  create: z.union([ ProfileMcpServerToolCreateInputSchema, ProfileMcpServerToolUncheckedCreateInputSchema ]),
  update: z.union([ ProfileMcpServerToolUpdateInputSchema, ProfileMcpServerToolUncheckedUpdateInputSchema ]),
}).strict();

export default ProfileMcpServerToolUpsertArgsSchema;
