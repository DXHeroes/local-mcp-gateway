...
export const McpServerToolsCacheFindManyArgsSchema: z.ZodType<Prisma.McpServerToolsCacheFindManyArgs> = z.object({
...
export default McpServerToolsCacheFindManyArgsSchema;
