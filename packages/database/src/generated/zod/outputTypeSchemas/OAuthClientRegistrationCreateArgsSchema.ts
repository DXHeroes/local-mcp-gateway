...
export const OAuthClientRegistrationCreateArgsSchema: z.ZodType<Prisma.OAuthClientRegistrationCreateArgs> = z.object({
  select: OAuthClientRegistrationSelectSchema.optional(),
  include: z.lazy(() => OAuthClientRegistrationIncludeSchema).optional(),
  data: z.union([ OAuthClientRegistrationCreateInputSchema, OAuthClientRegistrationUncheckedCreateInputSchema ]),
}).strict();

export default OAuthClientRegistrationCreateArgsSchema;
