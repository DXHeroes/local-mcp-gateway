...
export const DebugLogFindFirstOrThrowArgsSchema: z.ZodType<Prisma.DebugLogFindFirstOrThrowArgs> = z.object({
...
export default DebugLogFindFirstOrThrowArgsSchema;
