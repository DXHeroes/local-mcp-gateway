...
| **MCP Endpoint** | http://localhost:9631/mcp/default | Default profile MCP endpoint |
| **Health Check** | http://localhost:9631/health | Backend health status |
...
```json
{
  "mcpServers": {
    "local-gateway": {
      "url": "http://localhost:9631/mcp/default"
    }
  }
}
```
...
5. Use the profile's MCP endpoint: `http://localhost:9631/mcp/<profile-name>`
