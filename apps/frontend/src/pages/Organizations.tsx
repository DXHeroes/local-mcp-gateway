 ...
 * Organizations Page
 *
 * Settings page for the currently active organization:
 * members, invitations, and auto-join domains.
 */
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900">{activeOrg.name}</h2>
          <p className="text-sm text-gray-500">{activeOrg.slug}</p>
        </div>
      </div>
